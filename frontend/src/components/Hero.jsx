...
const Hero = () => {
  return (
    <section className="text-center py-10 md:py-16 px-4 md:px-6 animate-in fade-in zoom-in duration-700">
      ...
      <h1 className="text-4xl md:text-7xl font-black mb-6 leading-[1.1] tracking-tighter dark:text-white">
        Summarize Long <br className="hidden md:block" /> Content in Seconds
      </h1>
      <p className="text-base md:text-xl max-w-2xl mx-auto font-bold text-black/70 dark:text-gray-400">
